 ...
 * @author AnelisiweC
 */
public class AddPolygonLocation extends BaseClass {
    String errorMessage;
    int counter = 1;
    TestEntity testData;
    Date date = new Date();
    ...
    public AddPolygonLocation(TestEntity testData)
    {
...
//        SeleniumDriverInstance.CheckIfElementDisplayedByXpath("");
    ...
    {
        //SeleniumDriverInstance.pause(5000);
        if(!SeleniumDriverInstance.clickElementByXpathUsingActions("//i[@class='icon-shape-custom']"))
        {
            err.println("[ERROR] Failed to click polygon shape");
            return false;
        }
...
//        }
        ...
        SeleniumDriverInstance.takeScreenShot(counter + " - Successfuly clicked on polygon shape ", false);
        counter++;
        return true;
    }
     ...
     public boolean EnterLocationName()
    {
        ...
        //SeleniumDriverInstance.pause(2000);
        SeleniumDriverInstance.takeScreenShot(counter + " - Sucessfuly enter location name", false);
        counter++;
        return true;
    }
    public boolean LocationType()
    {
        ...
        //SeleniumDriverInstance.pause(2000);
        SeleniumDriverInstance.takeScreenShot(counter + " - Sucessfuly Choose Location Type", false);
        counter++;
        return true;
    }
    public boolean Site()
    {
        ...
        //SeleniumDriverInstance.pause(2000);
        SeleniumDriverInstance.takeScreenShot(counter + " -Sucessfuly Choose Site", false);
        counter++;
        return true;
    }
    public boolean LocationColor()
    {
        ...
        //SeleniumDriverInstance.pause(2000);
        SeleniumDriverInstance.takeScreenShot(counter + " - Sucessfuly Choose Location Color", false);
        counter++;
        return true;
    }
    public boolean Save()
    {
        ...
        //SeleniumDriverInstance.pause(2000);
        SeleniumDriverInstance.takeScreenShot(counter + " - Sucessfuly Click Save", false);
        return true;
    }
    public boolean Location()
    {
        ...
        //SeleniumDriverInstance.pause(2000);
        SeleniumDriverInstance.takeScreenShot(counter + " - Sucessfuly Click location", false);
        counter++;
        return true; 
    }
    public boolean Filter()
    {
        ...
        //SeleniumDriverInstance.pause(2000);
        SeleniumDriverInstance.takeScreenShot(counter + " - Sucessfuly Filter Location", false);
        counter++;
        return true; 
    }
...
//    }
    ...
    {
        return "//SELECT[@class='span12 ng-pristine ng-invalid ng-invalid-dmx-required']";
    }
